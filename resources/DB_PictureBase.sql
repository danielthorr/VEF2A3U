drop database if exists 0806933629_PictureBase;
create database 0806933629_PictureBase;
use 0806933629_PictureBase;
...
begin
	update Images set imageName = image_name, imagePath = image_path, imageText = image_text
